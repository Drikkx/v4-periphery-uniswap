...
import {IUniswapV4ERC1155} from "../../interfaces/external/IUniswapV4ERC1155.sol";
...
contract FullRangeERC1155 is BaseHook, ILockCallback {
    ...
    IUniswapV4ERC1155 internal erc1155;
    ...
    function addLiquidity(
        ...
        if (poolLiquidity == 0) {
            ...
            erc1155.mint(address(0), MINIMUM_LIQUIDITY, pool.liquidityId);
        }

        erc1155.mint(params.to, liquidity, pool.liquidityId);
    ...
    function beforeInitialize(
        ...
        poolInfo[poolId] = PoolInfo({
            ...
            liquidityId: poolIndex
        });
        
        ++poolIndex;

        return FullRangeERC1155.beforeInitialize.selector;
    }
    ...
    function beforeAddLiquidity(
        ...
        return FullRangeERC1155.beforeAddLiquidity.selector;
    }
    ...
    function _removeLiquidity(
        ...
        uint256 liquidityToRemove = FullMath.mulDiv(
            ...
            erc1155.totalSupply(pool.liquidityId)
        );
